...
const EditGuestButton = ({ guest, rooms }) => {
    ...
    const getRoomNo = async () => {
        const response = await fetch(`${API_URL}/rooms/${guest.room_id}`)
                                    ...
                                    <Form.Group as={Col} md="2" controlId="validationFormik01">
                                        ...
                                        >
                                            ...
                                            {rooms.map((room) => {
                                                return (
                                                    <>
                                                        <option key={room.room_no}>{room.room_no}</option>
                                                    </>
                                                )
                                            })}
                                        </Form.Select>
